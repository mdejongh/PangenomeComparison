package PangenomeComparison::PangenomeComparisonServer;
...
our %return_counts = (
        'build_pangenome' => 1,
        'build_pangenome_async' => 1,
        'build_pangenome_check' => 1,
        'compare_genomes' => 1,
        'compare_genomes_async' => 1,
        'compare_genomes_check' => 1,
        'version' => 1,
);

our %method_authentication = (
        'build_pangenome' => 'required',
        'build_pangenome_async' => 'required',
        'build_pangenome_check' => 'required',
        'compare_genomes' => 'optional',
        'compare_genomes_async' => 'required',
        'compare_genomes_check' => 'required',
);
...
our %async_run_methods = (
        'build_pangenome_async' => 'PangenomeComparison.build_pangenome',
        'compare_genomes_async' => 'PangenomeComparison.compare_genomes',
);

our %async_check_methods = (
        'build_pangenome_check' => 'PangenomeComparison.build_pangenome',
        'compare_genomes_check' => 'PangenomeComparison.compare_genomes',
);
...
sub call_method {
    ...
    my $ctx = PangenomeComparison::PangenomeComparisonServerContext->new($self->{loggers}->{userlog},
...
{
    # Service PangenomeComparison requires authentication.
	...
	{
	    $self->exception('PerlError', "Authentication required for PangenomeComparison but no authentication header was passed");
	}
    ...
    my @result;
    {
        ...
        my $stderr = PangenomeComparison::PangenomeComparisonServerStderrWrapper->new($ctx, $get_time);
        $ctx->stderr($stderr);
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service PangenomeComparison.");
    }
...
package PangenomeComparison::PangenomeComparisonServerContext;

use strict;

=head1 NAME

PangenomeComparison::PangenomeComparisonServerContext
...
package PangenomeComparison::PangenomeComparisonServerStderrWrapper;
...
unless (caller) {
    ...
    my $server = PangenomeComparison::PangenomeComparisonServer->new(

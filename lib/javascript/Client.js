...
function PangenomeComparison(url, auth, auth_cb, timeout, async_job_check_time_ms, async_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.build_pangenome = function (input, _callback, _errorCallback) {
        ...
        return json_call_ajax("PangenomeComparison.build_pangenome",
     ...
     this.compare_genomes = function (params, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("PangenomeComparison.compare_genomes",
